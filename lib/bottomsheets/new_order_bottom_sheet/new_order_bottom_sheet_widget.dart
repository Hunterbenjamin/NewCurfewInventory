                                        ...
                                        children:
                                          ...
                                          return InkWell(
                                            ...
                                            child: OrderOptionConponentWidget(
                                              key: Key(
                                                  'Keyzat_${orderOptionVarIndex}_of_${orderOptionVar.length}'),
                                              supplierReference:
                                                  orderOptionVarItem
                                                      .supplierReference,
                              ...
                              if (widget.newDraftOrders != null &&
                                ...
                                if (widget.newDraftOrders!
                                  ...
                                  await orderItemsRecordReference1
                                    ...
                                    itemReference:
                                        _model.selectedItemDocument?.reference,
                                    itemName:
                                  ...
                                  Navigator.pop(context, _model.newOrderItem1);
                                } else {
                                  ...
                                  await ordersRecordReference1
                                    ...
                                    supplierReference: _model
                                        .selectedOrderOption?.supplierReference,
                                    status: 'Draft',
                                    orderID: '10102',
                                  ));
                                  ...
                                  Navigator.pop(context, _model.newOrderItem2);
                                }
                              } else {
                                ...
                                Navigator.pop(context, _model.newOrderItem3);
                              }
