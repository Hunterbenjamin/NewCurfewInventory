...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF242E3A);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFF4B90E2);
  late Color alternate = const Color(0xFFC9CBD1);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF5A5C60);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFFFFF);
  late Color accent2 = const Color(0xFFC7CBD7);
  late Color accent3 = const Color(0xFF007AFF);
  late Color accent4 = const Color(0xFFE1E1E6);
  late Color success = const Color(0xFF137720);
  late Color warning = const Color(0xFFC96F46);
  late Color error = const Color(0xFFE65454);
  late Color info = const Color(0xFF4287FF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFF8AC7FF);
  ...
  late Color secondaryBackground = const Color(0xFF1E2428);
